...
(function initExcMenuModal() {
  const menu = document.getElementById('menu');
  if (!menu) return;

  const closeBtn = menu.querySelector('.modal__menu-close');
  ...
  document.querySelectorAll('.still__exc-wrap .excursion__link-more, .excursion__item-more.trigger').forEach(function(btn) {
...
document.querySelectorAll('.still__exc-wrap .excursion__link-more')